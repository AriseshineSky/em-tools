...
module Em
  module Tools
    module Domain
      ...
      #
      # 技术实现仍委托 {Em::Tools::LowestOfferListingsCoverageQuery}；本类只提供**业务命名入口**与
      # 「标识来源」的表达，便于按 DDD 渐进演进而不一次性重命名所有历史代码。
      module OfferListingFreshness
        ...
        class CoverageAssessment
          ...
          def snapshot_rows_for_all_configured_marketplaces(snapshot_captured_at:)
            LowestOfferListingsCoverageQuery.new(
