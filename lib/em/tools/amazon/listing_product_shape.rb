...
module Em
  module Tools
    module Amazon
      # Minimal shape aligned with +em_tasks.utils.product_converters.AmzProductConverter.convert+ top-level keys
      # used by +AmzUploadableProductsFormatter.process_products+ output (file-based formatter).
