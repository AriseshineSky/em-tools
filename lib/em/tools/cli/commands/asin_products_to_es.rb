        ...
        class AsinProductsToEs
          def run(argv)
            ...
            parser = OptionParser.new do |opts|
              ...
              opts.on('--asin-index NAME', String, 'Override ASIN source index (default amz_asins_<mp>).') do |v|
                options[:asin_index] = v
              end
            ...
            idx = options[:asin_index].to_s.strip
            filter_opts[:index] = idx unless idx.empty?
            ...
            pipeline = Em::Tools::Amazon::AsinProductIndexPipeline.new(
              marketplace: options[:marketplace],
