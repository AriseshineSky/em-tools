...
module Em
  module Tools
    ...
    class LowestOfferInventoryAsinLoader
      ...
      def load(mkt)
        ...
        @es_client.iterate_query(
          ...
          next unless LowestOfferAsinPattern.match?(sid)
      ...
      def warn_max_hits
        warn 'LowestOfferInventoryAsinLoader: hit LOWEST_OFFER_INVENTORY_MAX_HITS limit; ' \
