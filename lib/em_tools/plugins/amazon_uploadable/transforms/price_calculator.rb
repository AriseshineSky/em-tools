    ...
    module AmazonUploadable
      module Transforms
        ...
        class PriceCalculator
          ...
          #   a Numeric rate. Defaults to +EmTools::Clients::ExchangeRate.get_exchange_rate+.
          # rubocop:disable Metrics/ParameterLists -- mirrors Python constructor surface
          ...
          def calc_offer(src_offer)
            ...
            price = price_by_margin > price_by_product_cost ? price_by_product_cost : price_by_margin
