      ...
      module Cli
        ...
        class SyncInventory
          ...
          def run_sync(credentials, options)
            ...
            runner_opts = {
              product_util: product_util, sink: sink, sources: options[:sources],
              refresh: options[:refresh], prune_obsolete: options[:prune]
            }
          ...
          # rubocop:disable Style/FormatStringToken -- terminal column padding only
