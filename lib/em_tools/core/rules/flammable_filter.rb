...
module EmTools
  module Core
    module Rules
      # Block products with explicit flammable-liquid hazmat signals.
      ...
      class FlammableFilter < Strategy
        BLOCK_UN_IDS = %w[UN1987].to_set.freeze # ALCOHOLS, N.O.S.
        BLOCK_PRODUCT_TYPES = %w[HAND_SANITIZER].to_set.freeze
        ...
        def blocked_product_type(product, hazard_class)
          return nil unless hazard_class == '3'
