  ...
  module Core
    module Cli
      module Commands
        ...
        # {EmTools::Plugins::Amazon::LowestOffer::Sources::SeedFiles.sync_from_env!}.
        class GcsDownloadSeeds < Dry::CLI::Command
          ...
          def call(**)
            EmTools::Core::Cli::Runner.run do
              ...
              EmTools::Plugins::Amazon::LowestOffer::Sources::SeedFiles.sync_from_env!(target_dir: target)
