...
require 'spec_helper'
require 'em/tools/ebay_listings_coverage_query'

RSpec.describe Em::Tools::EbayListingsCoverageQuery do
  let(:es_client) { instance_double(Em::Clients::ElasticsearchClient) }
