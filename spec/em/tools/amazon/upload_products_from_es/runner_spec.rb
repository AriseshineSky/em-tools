...
RSpec.describe Em::Tools::Amazon::UploadProductsFromEs::Runner do
  ...
  it 'respects index override' do
    runner = described_class.new(marketplace: 'de', index: 'custom_idx', logger: logger)
    expect(runner.describe[:asin_index]).to eq('custom_idx')
  end
end
