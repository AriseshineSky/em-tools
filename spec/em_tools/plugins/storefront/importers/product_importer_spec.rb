...
RSpec.describe EmTools::Plugins::Storefront::Importers::ProductImporter do
  ...
  it 'filters products and emits batch payloads' do
    file = write_ndjson([
                          { 'product_id' => '1', 'price' => 39, 'categories' => 'Home > Kitchen',
                            'title' => 'Low price' }.to_json,
                          { 'product_id' => '2', 'price' => 49, 'categories' => 'Gift Cards > Cards',
                            'title' => 'Blocked category' }.to_json,
                          { 'product_id' => '3', 'price' => 50, 'categories' => 'Home > Tools', 'brand' => 'Acme',
                            'title_en' => 'Blacklisted item' }.to_json,
                          { 'product_id' => '4', 'price' => 60, 'categories' => 'Home > Tools', 'brand' => 'Acme',
                            'title' => 'Clean item' }.to_json
                        ])
