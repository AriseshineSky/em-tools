...
RSpec.describe(EmTools::Plugins::Amazon::Uploadable::Pipelines::AsinProductIndexPipeline) do
  let(:filter) { instance_double(EmTools::Plugins::Amazon::Uploadable::Filters::UploadableProductFilter) }
