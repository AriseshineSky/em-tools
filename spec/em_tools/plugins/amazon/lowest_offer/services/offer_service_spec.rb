...
RSpec.describe(EmTools::Plugins::Amazon::LowestOffer::Services::OfferService) do
  ...
  it "parses _source.offers JSON, applies the filter, attaches time, returns {asin => offer | nil}" do
    ...
    fba_filter = EmTools::Plugins::Amazon::LowestOffer::Filters::OfferFilter.new(
  ...
  it "marks offers expired when expire_hour is configured and time is older than threshold" do
    ...
    filter = EmTools::Plugins::Amazon::LowestOffer::Filters::OfferFilter.new(
