...
RSpec.describe(EmTools::Plugins::Ebay::Cli::PublishSnapshot) do
  it "passes the marketplace argument to the pipeline" do
    ...
    described_class.new.call(marketplace: "us")

    expect(EmTools::Plugins::Ebay::Pipelines::PublishSnapshot)
      .to(have_received(:new).with(hash_including(cli_marketplace: "us")))
  end
end
