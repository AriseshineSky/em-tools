...
RSpec.describe(EmTools::Plugins::AmazonLowestOffer::Sources::SeedFiles) do
  describe ".sync_from_env!" do
    it "lifts creds + GCS env defaults + canonical marketplace list into sync_from_gcs" do
      ...
      expect(captured[:marketplaces]).to(eq(
        EmTools::Plugins::AmazonLowestOffer::Queries::ListingsCoverageQuery::DEFAULT_MARKETPLACES,
      ))
    end
