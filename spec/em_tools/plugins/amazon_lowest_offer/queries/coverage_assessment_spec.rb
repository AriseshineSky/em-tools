...
RSpec.describe EmTools::Plugins::AmazonLowestOffer::Queries::CoverageAssessment do
  ...
  it 'delegates to LowestOfferListingsCoverageQuery with id_source seed' do
    ...
    expect(EmTools::Plugins::AmazonLowestOffer::Queries::ListingsCoverageQuery).to receive(:new).with(
      hash_including(es_client: client, id_source: 'seed', snapshot_time: captured_at, marketplaces: %w[de])
    ).and_return(query)

    rows = described_class.new(
      search_client: client,
      watched_product_id_source: EmTools::Plugins::AmazonLowestOffer::Queries::CoverageAssessment::WatchedProductIdSource::FROM_PROMOTION_SEED_FEED,
      marketplaces: %w[de]
  ...
  it 'maps operating inventory to id_source inventory' do
    ...
    row = described_class.new(
      search_client: client,
      watched_product_id_source: EmTools::Plugins::AmazonLowestOffer::Queries::CoverageAssessment::WatchedProductIdSource::FROM_OPERATING_INVENTORY
