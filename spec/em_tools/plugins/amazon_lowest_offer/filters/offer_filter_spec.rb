...
RSpec.describe EmTools::Plugins::AmazonLowestOffer::Filters::OfferFilter do
  def offer(**attrs)
    {
      'price' => 0.0, 'product_price' => 0.0, 'shipping_price' => 0.0, 'currency' => 'USD',
      'fba' => false, 'condition' => 'new', 'subcondition' => 'new'
